        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown navbar-toggler-right active">
                ...
                <div aria-labelledby="navbarDropdownMenuLink" class="dropdown-menu">
                    ...
                    <a class="dropdown-item" href="#" target="_blanck">
...
<nav class="navbar navbar-toggleable-md navbar-inverse bg-inverse nav">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav">
            ...
            <!-- user -->
            <li class="nav-item dropdown navbar-toggler-right active">
                <a aria-expanded="false" aria-haspopup="true" class="nav-link dropdown-toggle animated bounceInDown" data-toggle="dropdown" href="#" id="navbarDropdownMenuLink">
                    <span class="usu">
                        <i class="fa fa-user">
                        </i>
                    </span>
